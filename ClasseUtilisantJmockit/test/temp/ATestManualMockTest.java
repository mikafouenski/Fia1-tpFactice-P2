...
import temp.AtesterManualMock;
import temp.MockConversion;

public class ATestManualMockTest {

    @Mocked MockConversion c;
    private AtesterManualMock a;

    @Before
    public void init() {
        a = new AtesterManualMock();
        a.setC(c);
    }
    ...
    public void ATester_Test1() {
        new Expectations() {{
            a.convertit(0.0,"C2F"); result = 32.0;
        }};
    ...
    public void ATester_Test2() {
        new Expectations() {{
            a.convertit(32.0,"F2C"); result = 0.0;
        }};
    ...
    public void ATester_Test3() {
        new Expectations() {{
            a.convertit(37.0,"C2F"); result = 98.6;
        }};
    ...
    public void ATester_Test4() {
        new Expectations() {{
            a.convertit(98.6,"F2C"); result = 37.0;
        }};
